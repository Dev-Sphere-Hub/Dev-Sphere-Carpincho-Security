...
const NewsCard = ({ news, onClick }) => {
  return (
    <div className="flex w-[21rem] my-4 lg:m-4 p-3 pb-5 bg-colorCustom6 drop-shadow-md rounded-xl items-start text-center text-neutral-900" onClick={() => onClick(news)}>
