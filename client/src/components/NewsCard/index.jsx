...
const NewsCard = ({ news }) => {
    return (
        <div className='max-w-sm lg:max-w-none lg:w-[20rem] mx-4 w-full h-[12rem] lg:h-[24rem] px-2 py-4 bg-gray-50 drop-shadow-md rounded-md flex justify-around items-end text-center text-neutral-900'>
