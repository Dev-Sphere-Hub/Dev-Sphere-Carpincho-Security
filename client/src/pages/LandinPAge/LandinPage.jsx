...
const LandinPage = () => {
  ...
  return (
    <section className='landingPage relative w-[100%] h-screen bg-green-300 left-0 top-0'>
      ...
      <section
        className='contenudoTextios w-[100%] md:w-[50%] md:h-[100%] md:absolute md:top-0 md:left-0 md:flex md:flex-col md:justify-center md:items-center gap-5 bg-green-300 shadow-[0_0_0_6px_rgba(35,17,44,0.05)] backdrop-blur-[6px]'
      >
